class AppString {
  /// const
  static const String appName = "Akhbar";
  /// paths
  ...
  static const String imgEnvironment = "${_imgBase}environment.png";
  static const String imgScience = "${_imgBase}science.png";
  static const String imgTechnology = "${_imgBase}science.png";
}